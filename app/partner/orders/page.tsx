  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">受注一覧 {pagination ? `(${pagination.total}件)` : ''}</p>
      </div>
      ...
      <div className="mb-4">
        <Select value={status} onValueChange={(v) => { setStatus(v === 'all' ? '' : v); setPage(1) }}>
          ...
          <SelectContent>
            ...
            <SelectItem value="ordered">受注</SelectItem>
      ...
      {isLoading ? (
        ...
        <OrderList orders={orders} basePath="/partner/orders" showMember />
      )}
